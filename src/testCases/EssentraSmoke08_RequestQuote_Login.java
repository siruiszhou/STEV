...
public class EssentraSmoke08_RequestQuote_Login {
	private static WebDriver driver = null;

	@Test (groups = {"p0"})
	public void testRequestQuote_Login_PDP() throws Exception{
		...
		RequestQuoteLogin.InputDetails(driver);
		Homepage.header.get_Link_logout(driver).click();     
	    //*********Step3*********
	}
	
	@Test (groups = {"p0"})
	public void testRequestQuote_Login_PLP() throws Exception{
		Homepage.header.get_Link_Login(driver).click();
		WF04Logon.Logon(driver);
		/*
		 *step1: add items to basket 
	...
	@Test (groups = {"p0"})
	public void testRequestQuote_Login_PIP() throws Exception{
