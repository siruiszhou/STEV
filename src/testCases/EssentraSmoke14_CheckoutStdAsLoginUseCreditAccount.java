...
//Created By Simba Ji
public class EssentraSmoke14_CheckoutStdAsLoginUseCreditAccount {
	private static WebDriver driver = null;

	@Test (groups = {"p0"})
	public void testCheckoutStdAsLoginUseCreditAccount() throws Exception{
		...
		WF37PaymentAction.selectAccount(driver);
