...
//Created By Simba Ji
public class EssentraSmoke12_CheckoutSmplAsLogin {
	private static WebDriver driver = null;

	@Test (groups = {"p0"})
	public void testCheckoutSmplAsLogin() throws Exception{
	...
	public void beforeClass(String localSite, String browserType, String siteEnv) throws Exception {
		...
		driver = Utils.openBrowserByURL(browserType, Constant.get_sampleURL());
	}
