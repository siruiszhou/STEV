...
public class EssentraSmoke38_RejectJoinRequest {
	private static WebDriver driver = null;


	@Test (groups = {"p0"})
	public void testDenyJoinerRequest() throws Exception{
		//*********Step2*********
		...
		ManageUsersAccountDetails.DenyButton(driver, firstname).click();
//		
//		Deny Verification
//		
