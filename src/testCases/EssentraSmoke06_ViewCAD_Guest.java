...
public class EssentraSmoke06_ViewCAD_Guest {
	private static WebDriver driver = null;

	@Test (groups = {"p0"})
	public void testViewCAD_PDP() throws Exception{
		...
		ViewCADGuest.InputDetails(driver);     
	    //*********Step3*********
	}
	@Test (groups = {"p0"})
	public void testViewCAD_PIP() throws Exception{
		DataLoader Constant = new DataLoader();
	...
	@Test (groups = {"p0"})
	public void testViewCAD_PLP() throws Exception{
		DataLoader Constant = new DataLoader();
