...
//Created By Simba Ji
public class EssentraSmoke16_CheckoutStdAsLoginUseCreditCard {
	private static WebDriver driver = null;

	@Test (groups = {"p0"})
	public void testCheckoutStdAsLoginUseCreditCard() throws Exception{
		...
		WF37PaymentAction.selectCard(driver);
		WF37PaymentCreditCardAction.EnterCardAddress(driver);
		WF37PaymentCreditCardAction.ConfirmAddressAsLoginAndWaitForDataCash(driver);
