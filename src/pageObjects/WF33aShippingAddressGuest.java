...
public class WF33aShippingAddressGuest {
	...
	public static class button{
		public static WebElement get_button_ContinueToShipping(WebDriver driver){
			element = driver.findElement(By.xpath(".//*[@id='site_bd']/form/div[2]/div/button"));
			Log.info("Continue shipping method button found on WF33aShippingAddressGuest");
			return element;
		}
