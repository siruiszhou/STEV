...
public class RequestQuoteGuestOverlay {
	private static WebElement element = null;

	public static class field{
		public static WebElement get_field_quantity(WebDriver driver){
			element = driver.findElement(By.xpath(".//*[@id='guestInfoForm']/form/div[2]/div[1]/ul/li/div[3]/div/div/input"));
		...
		public static WebElement get_field_county(WebDriver driver){
			element = driver.findElement(By.xpath(".//*[@id='guestInfoForm']/form/div[2]/div[2]/ul/li[8]/select/option[3]"));
